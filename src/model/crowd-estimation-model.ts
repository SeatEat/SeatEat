...
class EstimationFactors {
    static estimationFactorArray: EstimationTimeFactor[] = [
        { hourStart: 0, hourEnd: 6, estimationFactor: 0 },
        { hourStart: 6, hourEnd: 8, estimationFactor: 0.1 },
        { hourStart: 8, hourEnd: 12, estimationFactor: 0.2 },
        { hourStart: 12, hourEnd: 13, estimationFactor: 0.4 },
        { hourStart: 13, hourEnd: 16, estimationFactor: 0.2 },
        { hourStart: 16, hourEnd: 18, estimationFactor: 0.1 },
        { hourStart: 18, hourEnd: 24, estimationFactor: 0 },
    ]
...
export default class CrowdEstimationModel {
    ...
    public async estimateChapterCrowdedness(): Promise<CrowdEstimationData> {
        ...
        const r = await fetch('');
        return new CrowdEstimationData([], new Date());
    }
}